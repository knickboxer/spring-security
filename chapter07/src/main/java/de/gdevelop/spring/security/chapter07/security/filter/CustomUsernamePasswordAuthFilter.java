...
import de.gdevelop.spring.security.chapter07.security.authentication.UsernamePasswordAuthentication;
import de.gdevelop.spring.security.chapter07.security.store.CustomTokenStore;
...
public class CustomUsernamePasswordAuthFilter extends OncePerRequestFilter {
   ...
   CustomTokenStore customTokenStore;
    ...
    private Authentication getAuthenticationFromAuthorizeRequest(HttpServletRequest request) {
        ...
        return new UsernamePasswordAuthentication(usernameAndPassword[0], usernameAndPassword[1]);
    }
